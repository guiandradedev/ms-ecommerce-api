...
import { ISecurityAdapter, SecurityDecryptResponse } from '@/modules/adapters/SecurityAdapter/ISecurityAdapter';
...
describe("Session Service", async () => {
    ...
    it('should create a valid token and refresh_token', async () => {
        ...
        const user: CreateSessionRequest = {email: 'fake_email@email.com', id: "fake_user_id", role: "USER"}
