...
interface IKafkaConsumerRequest extends IMessageBrokerConsumeRequest {
    eachMessage: (data: EachMessagePayload)=>Promise<void>
}
...
export class KafkaAdapter implements IMessageBrokerAdapter {
    ...
    async consume({topic, eachMessage}: IKafkaConsumerRequest): Promise<void> {
